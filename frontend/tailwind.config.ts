  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        ibime: {
          navy: "hsl(var(--ebime-navy))",
          red: "hsl(var(--ebime-red))",
          lightblue: "hsl(var(--ebime-lightblue))",
          darkred: "hsl(var(--ebime-darkred))",
          midnight: "hsl(var(--ebime-midnight))",
      ...
      backgroundImage: {
        ...
        "gradient-institutional": "linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--secondary)) 100%)",
      },
    },
  },
