/**
 * backend/src/shared/validators/schemas.ts
 *
 * Local copy of shared Zod schemas for backend validation.
 * Kept in sync with the root shared/validators/schemas.ts.
 *
...
export const createCourseRegistrationSchema = z.object({
  ...
  phone: z
    ...
    .regex(/^[\d\s\-+().a-zA-Z,]{7,40}$/, 'Número de teléfono inválido'),
  courseName: z
    .string()
